...
public class Demo {
	...
	public static void main(String [] args){
	 ...
	 void print(LinkedList <?> lt){
		 if (lt.size() == 0)	System.out.println( "  list is EMPTY.\n");
		 for (lt.go_to_first(); lt.cursor_ok(); lt.step_fwd()) {
			 System.out.println(lt);
			 }
	 }
	 public <T extends Comparable<T>> void try_to_find(LinkedList<?>  lt, Integer key ){
		 lt.find(key);
		 if (lt.cursor_ok())	System.out.println ("Found: " + lt );
		 else	System.out.println("Sorry, couldn't find key: " +  key + " in the table.\n");
	 }
}